...
export default function HeaderSM() {
  ...
  return (
    <div>
      ...
      {isActive && (
        <div
          className="fixed w-full z-10 left-0  p  cursor-pointer py-4 bg-white top-14 self-right pri"
        ...
        >
          ...
          <ul>
            ...
            >
              <p className="uppercase px-5">Customers</p>{" "}
              <img src={Drop} alt="" className="mx-3" />
            </li>
            <div>
              {isCustomerActive && (
            ...
            >
              <p className="uppercase px-5">BUSINESSES</p>{" "}
              <img src={Drop} alt="" className="mx-3" />
            </li>
            <div>
              {isBusinessActive && (
            ...
            >
              <p className="uppercase px-5">SETTINGS</p>{" "}
              <img src={Drop} alt="" className="mx-3" />
            </li>
            <div>
              {isSettingsActive && (
          ...
          <Link to="/">
            <p className="px-5 my-5" style={{ color: "red" }}>
              Log Out
            </p>
          </Link>
        </div>
